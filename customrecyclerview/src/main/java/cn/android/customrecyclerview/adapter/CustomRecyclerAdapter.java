package cn.android.customrecyclerview.adapter;
...
public class CustomRecyclerAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements ItemTouchAdapter {
     ...
     * @param spanCount
     */
    public void setHeaderView(View mHeaderView, int spanCount,int headerPosition){
        if(mHeaderView == null){
            return;
        }
        if(headerPosition>mHeaderViews.size()){
            ...
            mHeaderViews.add(headerPosition,mHeaderView);
        }
        this.spanCount = spanCount;
        this.notifyDataSetChanged();
    }
