...
import cn.android.customrecyclerview.touchHelper.ItemTouchHelperFactory;
...
public class RecyclerViewUtils {
    ...
    public void setHeaderView(RecyclerView mRecycler, View header,int postion){
        RecyclerView.Adapter mAdapter = mRecycler.getAdapter();
        ...
        realAdapter.setHeaderView(header, spanCount,postion);
    }
    /**
     * remove recyclerView的header
     */
    public void removeHeaderView(RecyclerView mRecycler, View headView){
        RecyclerView.Adapter mAdapter = mRecycler.getAdapter();
        if(mAdapter == null || !(mAdapter instanceof CustomRecyclerAdapter)){
            return ;
        }
        CustomRecyclerAdapter realAdapter = (CustomRecyclerAdapter)mAdapter;
        realAdapter.removeHeadView(headView);
    }
